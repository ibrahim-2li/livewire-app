            ...
            <div class="modal-content border-0 rounded-4 overflow-hidden" style="border: 1px solid #6f42c1 !important;">
                ...
                <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="modal-title fw-bold text-dark mb-0">@lang('Attendance Details')</h5>
                            <small class="text-muted">@lang('Person ID') : #{{ $user_id }}</small>
                        </div>
                    </div>
                ...
                <div class="modal-body px-4 pt-2 pb-4">
                    ...
                    <!-- <div class="text-center mb-4">
                        <div class="d-inline-block rounded-circle p-1 border border-2" style="border-color: #6f42c1 !important;">
                             <img src="{{ $avatar }}" alt="Avatar" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                        </div>
                    </div> -->
                    ...
                    <div class="card border-0 shadow-sm mb-3 rounded-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-3">
                                    <label class="small text-muted d-block mb-1">@lang('Country')</label>
                                    <div class="fw-bold text-dark">{{ __($country) }}</div>
                                </div>
                                 <div class="col-md-6">
                    ...
                    <div class="card border-0 shadow-sm mb-3 rounded-4">
                        <div class="card-body p-4">
                            <h6 class="fw-bold mb-4" style="color: #6f42c1;"><i class="fas fa-qrcode me-2"></i>@lang('QR Code')</h6>
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    @if ($qrcodes && $qrcodes->count() > 0 && $used_at === null)
                                            ...
                                            @endforeach
                                        @else
                                            <p class="m-0 text-success">Checked In Successfully at {{ $used_at }}</p>
                                        @endif
                                </div>
                            </div>
                        </div>
