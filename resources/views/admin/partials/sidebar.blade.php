<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('events.index') }}" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="{{ asset('admin-assets/img/icons/unicons/logo.png') }}" alt="Logo" width="25">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">@lang('Events')</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @if (auth('admin')->user()->isAdmin())
            ...
            <li class="menu-item @yield('events-active')">
                <a href="{{ route('admin.events') }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">@lang('Events')</div>
                </a>
            </li>
            ...
            <li class="menu-item @yield('messages-active')">
                <a href="{{ route('admin.messages') }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">@lang('Messages') </div>
            ...
            <li class="menu-item @yield('users-active')">
                <a href="{{ route('admin.users') }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">@lang('Users')</div>
                </a>
            </li>
        @endif

        <!-- MyAttendances (All users) -->
        <li class="menu-item @yield('my-attendances-active')">
            <a href="{{ route('admin.my-attendances') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calendar-star"></i>
                <div data-i18n="Analytics">@lang('My Attendances')</div>
            </a>
        </li>
        ...
        @if (auth('admin')->user()->isAdmin() || auth('admin')->user()->isScanner())
            ...
            <li class="menu-item @yield('qr-scanner-active')">
                <a href="{{ route('admin.qr-scanner') }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">@lang('QR Scanner')</div>
                </a>
            </li>
        @endif
        ...
        <li class="menu-item @yield('account-active')">
            <a href="{{ route('admin.account') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user-circle me-1"></i>
                <div data-i18n="Analytics">@lang('Account Settings')</div>
            </a>
        </li>
        ...
        @if (auth('admin')->user()->isAdmin())
            ...
            <li class="menu-item @yield('settings-active')">
                <a href="{{ route('admin.settings') }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">@lang('Settings')</div>
                </a>
            </li>
        @endif
